 ...
 */
class reservation extends \SNT\ReservationBundle\Entity\reservation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\reservation' . "\0" . 'id', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\reservation' . "\0" . 'date', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\reservation' . "\0" . 'etat', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\reservation' . "\0" . 'bien', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\reservation' . "\0" . 'client'];
        }
