 ...
 */
class proprietaire extends \SNT\ReservationBundle\Entity\proprietaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\proprietaire' . "\0" . 'id', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\proprietaire' . "\0" . 'numPiece', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\proprietaire' . "\0" . 'nomComplet', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\proprietaire' . "\0" . 'adresse', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\proprietaire' . "\0" . 'tel', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\proprietaire' . "\0" . 'email', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\proprietaire' . "\0" . 'codeBanque'];
        }
