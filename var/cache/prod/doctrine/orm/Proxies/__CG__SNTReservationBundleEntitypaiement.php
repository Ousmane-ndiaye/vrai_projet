 ...
 */
class paiement extends \SNT\ReservationBundle\Entity\paiement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\paiement' . "\0" . 'id', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\paiement' . "\0" . 'datePaiement', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\paiement' . "\0" . 'montant', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\paiement' . "\0" . 'periode', '' . "\0" . 'SNT\\ReservationBundle\\Entity\\paiement' . "\0" . 'idContrat'];
        }
